...
//       if (status === "granted") {
//         const uri = FileSystem.cacheDirectory + "interviews.txt";
//         await FileSystem.writeAsStringAsync(uri, JSON.stringify(interviews));
//         await MediaLibrary.createAssetAsync(uri);
//         Alert.alert(
//           "Downloaded",
//           "Your interviews list has been downloaded successfully."
//         );
//       } else {
//         Alert.alert(
//           "Permission Denied",
...
//       Alert.alert(
//         "Error",
//         "Failed to download interviews list. Please try again later."
//       );
//     }
//   };
...
//         >
//           <FontAwesome5 name="download" solid style={styles.icon} />
