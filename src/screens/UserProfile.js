  ...
  return (
    <View style={styles.container}>
      ...
      <Text style={styles.description}>
        {user.description ||
          "Associate Full Stack Engineer | Software Engineering Undergraduate at SLIIT | Developer | Blogger | Tech Enthusiast"}
      </Text>
          ...
          <Center>
            <Actionsheet isOpen={isOpen} onClose={onClose}>
              <Actionsheet.Content>
                ...
                <Actionsheet.Item onPress={selectFile}>
                  Open Camera
                </Actionsheet.Item>
                <Actionsheet.Item onPress={pickDocument}>
                  Select from gallery
                </Actionsheet.Item>
              </Actionsheet.Content>
            </Actionsheet>
